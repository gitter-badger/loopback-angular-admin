[![Stories in Ready](https://badge.waffle.io/movibe/loopback-angular-admin.png?label=ready&title=Ready)](https://waffle.io/movibe/loopback-angular-admin)
# Loopback Angular Admin version Gulp

[![Join the chat at https://gitter.im/movibe/loopback-angular-admin](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/movibe/loopback-angular-admin?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
- Angular UI-Router
- JSON-based based forms by [angular-autofields-bootstrap](https://github.com/JustMaier/angular-autofields-bootstrap)
...
### The one-liner install (please create an [issue](https://github.com/beeman/loopback-angular-admin/issues/new) if this one does not work!)
    ...
    git clone https://github.com/movibe/loopback-angular-admin.git && cd loopback-angular-admin && npm install && gulp && node server/server.js

### The steps above: 

### Checkout the project:

    git clone https://github.com/movibe/loopback-angular-admin.git
